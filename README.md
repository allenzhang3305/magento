...
`--ssl-mode=DISABLED` stands for [an unencrypted connection especially for the legacy versions.](https://dev.mysql.com/doc/refman/5.7/en/connection-options.html#option_general_ssl-mode).
